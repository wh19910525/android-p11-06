...
public class Day06_05_SimpleAdapterActivity extends Activity {
	...
	private void setupView() {
		...
		String[] from = { "icon", "id", "name", "age", "sex" };
		int[] to = { R.id.ivHead, R.id.tvId, R.id.tvName, R.id.tvAge, R.id.tvSex };

		adapter = new SimpleAdapter(this, biz.getStudents(), R.layout.item, from, to);
