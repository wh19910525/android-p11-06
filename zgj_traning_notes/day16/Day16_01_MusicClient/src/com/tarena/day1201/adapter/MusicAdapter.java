...
public class MusicAdapter extends BaseAdapter {
	...
	public void flush() {
		if (musics != null) {
			Comparator<Music> comparator = prefUtils.getComparator();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 确定显示列
		if (prefUtils.showAlbum())
			holder.tvAlbum.setVisibility(View.VISIBLE);
		else
			holder.tvAlbum.setVisibility(View.GONE);
		if (prefUtils.showSinger())
			holder.tvSinger.setVisibility(View.VISIBLE);
		else
			holder.tvSinger.setVisibility(View.GONE);
		if (prefUtils.showDuration())
